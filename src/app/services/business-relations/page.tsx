...
const stats = [
  { value: '500+', label: 'Kompaniyalar', description: 'Tarmoqda' },
  { value: '1000+', label: 'Uchrashuvlar', description: 'Tashkil etilgan' },
  { value: '300+', label: 'Shartnomalar', description: 'Natija' },
  { value: '35+', label: 'Sektorlar', description: 'Qamrov' },
]
...
const services = [
  {
    icon: Network,
    title: 'B2B Matching',
    description: 'Sizning biznesingizga mos hamkorlarni topish va ulash xizmati',
  },
  {
    icon: Calendar,
    title: 'Biznes Uchrashuvlar',
    description: 'Potensial hamkorlar bilan uchrashuvlarni tashkil etish',
  },
  {
    icon: Link2,
    title: 'Ta\'minot Zanjirlari',
    description: 'Yetkazib beruvchilar va xaridorlar bilan aloqalarni yo\'lga qo\'yish',
  },
  {
    icon: MessageSquare,
    title: 'Biznes Muzokara',
    description: 'Professional muzokara va shartnoma tuzishda yordam',
  },
]
...
const matchingProcess = [
  {
    ...
    description: 'Biznesingiz haqida batafsil ma\'lumot to\'plash va ehtiyojlarni aniqlash',
  },
  {
    step: '02',
    title: 'Hamkor qidirish',
    description: 'Bazamizdan sizga mos hamkorlarni tanlash va tahlil qilish',
  },
  {
    step: '03',
    title: 'Uchrashuv tashkil etish',
    description: 'Potensial hamkorlar bilan uchrashuvlarni rejalashtirish',
  },
  {
    step: '04',
    title: 'Natija',
    description: 'Shartnoma tuzish va uzoq muddatli hamkorlikni boshlash',
  },
]
...
const partnerTypes = [
  {
    ...
    description: 'Xom ashyo va materiallar yetkazib beruvchilarni topish',
    icon: Building2,
    count: '200+',
  },
  {
    title: 'Distribyutorlar',
    description: 'Mahsulotlaringizni tarqatuvchi hamkorlar',
    icon: TrendingUp,
    count: '150+',
  },
  {
    title: 'Ishlab chiqaruvchilar',
    description: 'Buyurtma asosida ishlab chiqarish hamkorlari',
    icon: Briefcase,
    count: '100+',
  },
  {
    title: 'Xizmat ko\'rsatuvchilar',
    description: 'Biznes xizmatlari bo\'yicha hamkorlar',
    icon: Users,
    count: '150+',
  },
]
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-white/50 mb-6 leading-relaxed">
                  B2B hamkorliklar va biznes aloqalarni rivojlantirish platformasi.
                  Yetkazib beruvchilar, distribyutorlar va strategik hamkorlarni toping.
                  500+ kompaniya tarmoqiga qo'shiling.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Link href="/contact" className="btn-primary">
                    <span>Hamkor topish</span>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="font-heading text-2xl lg:text-3xl font-semibold text-white mb-4">
                Qanday{' '}
                <span className="text-gradient-gold font-display">ishlaydi</span>
              </h2>
            </motion.div>
        ...
        <section className="relative py-16">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              <h2 className="font-heading text-2xl lg:text-3xl font-semibold text-white">
                Hamkor{' '}
                <span className="text-gradient-gold font-display">turlari</span>
              </h2>
            </motion.div>
        ...
        <section className="relative py-16">
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              <h2 className="font-heading text-2xl lg:text-3xl font-semibold text-white mb-4">
                Hamkor{' '}
                <span className="text-gradient-gold font-display">tarmog'iga qo'shiling</span>
              </h2>
              <p className="text-white/50 mb-8">
                500+ kompaniya tarmoqiga qo'shiling va biznesingiz uchun
                eng yaxshi hamkorlarni toping.
              </p>
