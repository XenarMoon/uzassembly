...
export default function ContactClient({ settings }: ContactClientProps) {
  ...
  const contactInfo = {
    address: {
      full: locale === 'en' ? (settings.addressEn || defaultContactInfo.address.full) :
            locale === 'ru' ? (settings.addressRu || defaultContactInfo.address.full) :
            (settings.address || defaultContactInfo.address.full),
      street: locale === 'en' ? (settings.addressEn || defaultContactInfo.address.street) :
              locale === 'ru' ? (settings.addressRu || defaultContactInfo.address.street) :
              (settings.address || defaultContactInfo.address.street),
    },
    phone: {
      main: settings.phone1 || defaultContactInfo.phone.main,
      formatted: settings.phone1 || defaultContactInfo.phone.formatted,
    },
    email: {
      main: settings.email || defaultContactInfo.email.main,
    },
    social: {
      telegram: settings.telegram || defaultContactInfo.social.telegram,
      instagram: settings.instagram || defaultContactInfo.social.instagram,
      facebook: settings.facebook || defaultContactInfo.social.facebook,
      youtube: settings.youtube || defaultContactInfo.social.youtube,
      linkedin: settings.linkedin || defaultContactInfo.social.linkedin,
    },
    map: {
      lat: parseFloat(settings.mapLat) || defaultContactInfo.map.lat,
      lng: parseFloat(settings.mapLng) || defaultContactInfo.map.lng,
    },
  }
  ...
  const contactReasons = contactReasonsConfig.map((reason) => ({
    ...reason,
    title: t(`reasons.${reason.key}.title`),
    description: t(`reasons.${reason.key}.description`),
  }))

  const faqItems = faqItemsConfig.map((faq) => ({
    ...faq,
  ...
  return (
    <main ref={containerRef} className="relative bg-navy-900 overflow-hidden mt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <h3 className="font-semibold text-white mb-2">{t('cards.phone.title')}</h3>
              <a
            ...
            >
              ...
              <h3 className="font-semibold text-white mb-2">{t('cards.email.title')}</h3>
              <a
            ...
            >
              ...
              <h3 className="font-semibold text-white mb-2">{t('cards.hours.title')}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <div className="mb-6">
                ...
                <h2 className="font-heading text-2xl lg:text-3xl font-semibold text-white">
                  {t('form.headline')}{' '}
                  <span className="text-gradient-gold font-display">{t('form.headlineHighlight')}</span>
                </h2>
              </div>
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="font-semibold text-white text-xl mb-2">{t('form.success.title')}</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label className="block text-white/60 text-sm mb-2">{t('form.labels.reasonType')}</label>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-white/60 text-sm mb-2">{t('form.labels.name')} *</label>
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                    ...
                    <div>
                      <label className="block text-white/60 text-sm mb-2">{t('form.labels.email')} *</label>
                      <input
                        type="email"
                        name="email"
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-white/60 text-sm mb-2">{t('form.labels.phone')}</label>
                      <input
                        type="tel"
                        name="phone"
                    ...
                    <div>
                      <label className="block text-white/60 text-sm mb-2">{t('form.labels.company')}</label>
                      <input
                        type="text"
                        name="company"
                  ...
                  <div>
                    <label className="block text-white/60 text-sm mb-2">{t('form.labels.message')} *</label>
                    <textarea
                      name="message"
            ...
            >
                ...
                <div className="w-full h-full bg-navy-800 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold text-white mb-2">{t('map.city')}</h3>
              ...
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                <h3 className="font-semibold text-white mb-4">{t('social.title')}</h3>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-gold-500/10 via-navy-800/50 to-navy-900 border border-gold-500/20">
                <h3 className="font-semibold text-white mb-3">{t('quickContact.title')}</h3>
                <p className="text-white/50 text-sm mb-4">
      ...
      <section className="relative py-12 lg:py-16">
        ...
        <div className={cn('h-8 mb-28')} id="faq" />
        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="font-heading text-2xl lg:text-3xl font-semibold text-white">
              <span className="text-gradient-gold font-display">{t('faqSection.headline')}</span>
            </h2>
          </motion.div>
