...
// Service configurations with translation keys
...
// Benefit configurations with translation keys
...
// Featured projects configurations
const featuredProjectsConfig = [
  { key: 'smartCity', value: '6,400 ga' },
  { key: 'investHub', value: '$20B+' },
  { key: 'eduJob', value: '1000+' },
]
...
export default function ServicesPage() {
  ...
  const services = servicesConfig.map((service) => ({
    ...
    features: t.raw(`services.${service.key}.features`) as string[],
    statsLabel: t(`services.${service.key}.statsLabel`),
  }))
  ...
  const featuredProjects = featuredProjectsConfig.map((project) => ({
    ...project,
